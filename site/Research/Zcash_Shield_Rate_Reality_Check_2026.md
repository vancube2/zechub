...
1. A fully private (z→z) transaction, where money stays inside the pool. That one really
   is private.
2. A deshielding (z→t) transaction, where money is leaving the pool to become visible.
